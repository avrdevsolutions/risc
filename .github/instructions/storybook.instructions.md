...
- Project tokens only — never use default Tailwind palette in story decorators or render functions.
...
- **New primitive** → create `<Name>.stories.tsx` alongside the component (see `ui-primitives.instructions.md` §Creating).
