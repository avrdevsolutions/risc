...
**Source**: ADR-0002 §Component Library Strategy, §Restyling Checklist, §className Override Depth
...
The 6 Required primitives (Typography, Button, Container, Stack, Badge, Separator) are already in `src/components/ui/` — see `skills/ui-primitives/`. **Do not rebuild them.** Customize their visual values from the mockup.
