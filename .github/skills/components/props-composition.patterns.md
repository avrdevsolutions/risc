...
**Source**: ADR-0004 §Props Patterns, §Composition Patterns, §Export Rules
**Last synced**: 2026-03-13

> For server/client composition patterns (server-as-children, extract-interactive), see `boundaries.patterns.md`.
