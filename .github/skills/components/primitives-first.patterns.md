...
**Source**: ADR-0004 §Primitives-First Rule
**Last synced**: 2026-03-13

> Cross-references: ADR-0023 (UI Foundation Primitives), ADR-0002 (Design Tokens).
...
1. Uses Tailwind default palette (`gray-600`, `blue-600`) — violates ADR-0002.
