...
**Source**: ADR-0004 §Server vs Client Components, §Loading Error and Suspense Boundaries
...
Hiding nav links on mobile screens without providing a mobile alternative is **forbidden** (violates ADR-0019 accessibility requirements).
