...
1. Read `public/_mockups/mockup-descriptions.json` and find the `chosen.file` key.
...
- `skills/styling/token-customization.patterns.md` §Step 1 — color extraction, flat vs scaled decision tree, HSL conversion
- `skills/ui-primitives/customization.patterns.md` §Mockup-Driven Customization — what the mockup drives vs doesn't, variant discovery from recurring patterns
- `skills/ui-primitives/customization.patterns.md` §Typography Variant Discovery — scan, group, map, translate text styles to variants
...
Write the brief to: **`.github/flow-generator/FE/specs/foundation-brief.md`**
...
For each of the 7 Required primitives, describe:
...
If the mockup reveals a need for additional primitives beyond the 7 Required (e.g., Card, Input, Dialog), include those here too.
