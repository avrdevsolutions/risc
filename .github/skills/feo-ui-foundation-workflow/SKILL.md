...
| Skill         | File                                             | Contains                                                                                    |
| ------------- | ------------------------------------------------ | ------------------------------------------------------------------------------------------- |
| ui-primitives | `skills/ui-primitives/customization.patterns.md` | Variant discovery, color separation, cva updates, font registration, shadcn/ui relationship |
| styling       | `skills/styling/token-customization.patterns.md` | Flat vs scaled tokens, HSL conversion, config structure, color scale generation             |
