...
**Before doing anything**, verify `.github/flow-generator/FE/specs/design-brief.md` exists and is non-empty. If missing or empty, **STOP** and report.

## Length Target — CRITICAL

**80–130 lines maximum.** If your plan exceeds this, you are over-specifying. Each section in the breakdown should be 3–4 lines. The designer is skilled — trust them to interpret your intent. Brevity is a feature, not a compromise.

## What You Read

1. **Always read**: `.github/flow-generator/FE/specs/design-brief.md` — the orchestrator's design brief.
...
- `.github/skills/frontend-design/SKILL.md` — that is the designer's skill, not yours. You provide creative direction; the designer decides visual execution.
...
**`.github/flow-generator/FE/specs/design-planner-plan.md`**
...
After writing the plan to `design-planner-plan.md`, you MUST get explicit user approval before finishing.
...
- **Your plan must be 80–130 lines.** If it's longer, cut. Trust the designer.
