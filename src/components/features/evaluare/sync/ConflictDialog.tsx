 ...
 *
 * Rendered inside EvaluareSyncProvider so it can access syncAll + evaluareId.
 */
export const ConflictDialog = () => {
  ...
  return (
    <>
      ...
      >
        <div className='w-full max-w-md rounded-2xl border border-navy-100 bg-white p-6 shadow-2xl'>
          {/* Header */}
          ...
          <Typography variant='body-sm' className='mb-5 text-navy-600'>
